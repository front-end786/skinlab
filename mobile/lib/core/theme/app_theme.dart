...
class AppTheme {
  ...
  static ThemeData get light => ThemeData(
    ...
    inputDecorationTheme: InputDecorationTheme(
      ...
      errorStyle: AppTypography.caption.copyWith(color: AppColors.danger600),
    ...
    chipTheme: ChipThemeData(
      ...
      shape: RoundedRectangleBorder(borderRadius: AppLayout.borderRadiusFull),
    ),
    ...
    dialogTheme: DialogThemeData(
      backgroundColor: AppColors.surface,
      elevation: 16,
      shape: RoundedRectangleBorder(borderRadius: AppLayout.borderRadiusXl),
      titleTextStyle: AppTypography.h3,
