...
This guide explains how to set up PostgreSQL with Row-Level Security for SkinLab multi-tenancy.
...
```sql
-- Connect to skinlab database
\c skinlab

-- Grant connection rights
GRANT CONNECT ON DATABASE skinlab TO crm_user;
