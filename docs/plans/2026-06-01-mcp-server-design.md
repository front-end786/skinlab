...
Let users connect SkinLab to their AI agents / LLMs (Claude Desktop, custom
...
- **Streamable HTTP** (`bcrm-mcp --http`, hosted e.g. at `mcp.skinlab.io`): PAT
...
2. **Phase 2:** Streamable HTTP transport hosted at `mcp.skinlab.io`; per-token
