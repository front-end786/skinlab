# SkinLab Backend - Django REST API

The backend for SkinLab, a multi-tenant CRM platform built with Django REST Framework.
...
# Email
DEFAULT_FROM_EMAIL=noreply@skinlab.com
...
CREATE DATABASE skinlab WITH OWNER = postgres;
...
-- Grant permissions
GRANT CONNECT ON DATABASE skinlab TO crm_app;
