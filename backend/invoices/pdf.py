...
try:
    ...
    # OSError: native libs (GTK/Pango/Cairo) missing — common on Windows dev setups.
    WEASYPRINT_AVAILABLE = False
    CSS = HTML = FontConfiguration = None  # type: ignore[misc, assignment]
...
def check_weasyprint():
    ...
    if not WEASYPRINT_AVAILABLE:
        raise ImportError(
            "WeasyPrint is unavailable. On Linux/macOS install system libs "
            "(cairo, pango, gdk-pixbuf). On Windows see: "
